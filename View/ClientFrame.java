...
public class ClientFrame extends JFrame {
	...
	public JTextField txt_msg;
	public JTextField txt_port;
	public JButton btn_send; 
	public JButton btn_port ;
	public JList list_members ;
	public JButton btn_getMembers; 
	public JTextArea txt_display;
	...
	public ClientFrame() {
		...
		btn_port = new JButton("Port");
		
		list_members = new JList();
		
		btn_getMembers = new JButton("Get members");
				...
				.addGroup(Alignment.LEADING, gl_contentPane.createSequentialGroup()
					...
					.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_contentPane.createSequentialGroup()
							.addComponent(txt_port, GroupLayout.PREFERRED_SIZE, 124, GroupLayout.PREFERRED_SIZE)
							.addGap(18)
